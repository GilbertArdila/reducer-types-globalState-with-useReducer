...
const NavBar = ({setShowPage,showPage}) => {
  ...
  return (
    ...
    ><img src="https://cdn4.iconfinder.com/data/icons/ionicons/512/icon-ios7-cart-outline-64.png" alt="cart" /></div>:  showPage ?<div className='cart' onClick={() => setShowPage(false)}><img src='https://cdn0.iconfinder.com/data/icons/google-material-design-3-0/48/ic_home_48px-64.png' alt='home' /></div>:null}
